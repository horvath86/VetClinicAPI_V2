...
namespace VetClinicAPI_V2.DTO.Requests
{
    public class MedicalRecordCreateDTO
    {
        ...
        public ICollection<PrescriptionRequestDTO> Prescriptions { get; set; } = new List<PrescriptionRequestDTO>();

        public ICollection<ProcedureRecordRequestDTO> ProcedureRecords { get; set; } = new List<ProcedureRecordRequestDTO>();
